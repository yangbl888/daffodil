...
class PubPerson extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('IdNumber, Sex, Nation, Country, CreateBy, CreateUserId', 'length', 'max'=>40),
			array('Name', 'length', 'max'=>120),
			array('Address', 'length', 'max'=>80),
			array('Description', 'length', 'max'=>200),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('Id, IdNumber, Name, Sex, Nation, Address, Country, AllowEdit, AllowDel, SortCode, DeletionFlag, EnabledFlag, CreateOn, CreateBy, CreateUserId, Description', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		return new CActiveDataProvider($this, array(
			...
			//排序
			'sort'=>array(   
            'defaultOrder'=>array('Id'=>false),   //true是降序   
        ),   
		)	
		);
	}
