<?php $this->widget('zii.widgets.CMenu',array(
	...
	'items'=>array(
		array('label'=>'文章管理', 'url'=>array('#'),'items'=>array(
			...
			array('label'=>'管理文章', 'url'=>array('/admin/pubPerson/admin'), 'linkOptions'=>array('target'=>'navTab','rel'=>'art_manager')),
		        array('label'=>'管理文章test', 'url'=>array('/admin/pubPerson/admin'), 'linkOptions'=>array('target'=>'navTab','rel'=>'art_manager')),
                    )),
		array('label'=>'商标分类管理', 'url'=>array('/admin/tmtype/admin'),'items'=>array(
			array('label'=>'创建商标分类', 'url'=>array('demo_page1.html'), 'linkOptions'=>array('target'=>'navTab','rel'=>'tm_create')),
